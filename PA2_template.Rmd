...
The data are generally characterized by having a time component (bgn_date, end_date, etc), as well as information input into databases/standard format by individual observers.  As there are many possibilities in describing broad terms such as economic and health impacts, there are many values for the weather event type (i.e., there are n=????? distinct event types in this data).
