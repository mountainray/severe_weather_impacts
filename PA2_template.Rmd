...
<!-- fact|value -->
<!-- ----|----- -->
<!-- **record count, raw file**|`r nrow(raw_us_storms)` -->
<!-- **distinct refnum values**|`r count(distinct(raw_us_storms, refnum))` -->
<!-- **distinct evtype values**|`r count(distinct(raw_us_storms, evtype))` -->
<!-- **example bgn_date value**|`r raw_us_storms[1000,"bgn_date"]` -->
<!-- **example evtype value**|`r raw_us_storms[1000,"evtype"]` -->
<!-- **example propdmg value**|`r raw_us_storms[1000,"propdmg"]` -->
<!-- **example propdmgexp value**|`r raw_us_storms[1000,"propdmgexp"]` -->
<!-- **example injuries value**|`r raw_us_storms[1000,"injuries"]` -->
...
fact_value4 <- as.character(raw_us_storms[1000,"bgn_date"])
fact_value5 <- as.character(raw_us_storms[1000,"evtype"])
fact_value6 <- as.character(raw_us_storms[1000,"propdmg"])
fact_value7 <- as.character(raw_us_storms[1000,"propdmgexp"])
fact_value8 <- as.character(raw_us_storms[1000,"injuries"])
value <- union_all(fact_value1, fact_value2, fact_value3, fact_value4, 
			 fact_value5, fact_value6, fact_value7, fact_value8)
names(value) <- "value"
...
1. using a top top_n_filter_e list, `r (sum(economic$economic_damage2)/sum(sample_us_storms$economic_damage))*100`% of the universe/all events
2. using a top top_n_filter_h list, `r (sum(health$health_damage2)/sum(sample_us_storms$health_damage))*100`% of the universe/all events
